...
export const SERIES_EXAMPLES = [
  { soc_code: "11-1011", naics_codes: ["11", "23", "31-33"] },
  { soc_code: "15-1252", naics_codes: ["51", "54"] },
  { soc_code: "29-1141", naics_codes: ["62"] },
  { soc_code: "43-4051", naics_codes: ["72"] },
] as const;

export const WAGE_EXAMPLES = [
  {
    soc_code: "11-1011",
    naics_code: "11",
    year: 2023,
